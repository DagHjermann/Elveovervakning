...
# **NOTE: Making the final combined plot in the separate script `07b_Figures_2020_qualitymap_combine.R` **
...
gg2_north <- gg1_back_north +
  ...
  geom_text_right(
    ...
    y_even_dist = 14E3, y_even_pos = -20E3,
    color = "blue3", segment.color = "blue3") +
  geom_subview(data = df_pies_north, 
               aes(x = x, y = y, subview = pie, width = width, height = height)
               )
# gg
gg2_north
...
if (save_plots){
  fn1 <- glue("{folder_fig}/07c_qualitymap_nnorway.png")
  fn2 <- glue("{folder_fig}/07c_qualitymap_nnorway_hi.png")
  # fn <- glue("{folder_fig}/07c_qualitymap_TEST.png")
  scale <- 1.5
  ggsave(fn1, gg2_north, width = 15*scale, height = 11*scale, units = "cm", dpi = 500/scale)  
  ggsave(fn2, gg2_north, width = 15*scale, height = 11*scale, units = "cm", dpi = 1000/scale)  
}
