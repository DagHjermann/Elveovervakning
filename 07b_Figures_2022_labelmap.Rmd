...
#
# NOTE! JUST FOR NOW WE SET ALL RIVERS TO 'Økologisk tilstand'
# 
df_stations_all <- df_stations_all %>%
  mutate(Stasjonstype = "Økologisk tilstand")
...
# Keep these 2 counties (Trøndelag + Nordland)
df_counties <- df_counties_all %>%
  filter(id %in% c(9,5))
...
### a. Inset boxes, set UTM coordinates and dimensions  
