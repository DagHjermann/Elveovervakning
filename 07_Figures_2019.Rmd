...
### g. Version 4 with names - zoom region 1     
Ie Trøndelag  
```{r}
#
# Entire country
...
### g. Version 4 with names - zoom region 2     
Ie Nordland  
```{r}
#
# Entire country
...
for (i in 1:18){
  ...
  gg3 <- gg3 + 
    geom_polygon(data = df_counties %>% filter(L1 == 1 & id %in% i), 
                 aes(long, lat, group = group), fill = terrain.colors(10)[7], color = "grey40")
}
