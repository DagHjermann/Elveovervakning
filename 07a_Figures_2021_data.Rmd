...
Plots for report 2021 (*data* from 2020!)   
...
df_stations_all <- read_excel(
  "Data_input/2021/KartOgFigurgrunnlag_TilDag.xlsx", 
...
```{r}
# readxl::excel_sheets("Data_input/2021/Klassifisering av økologisk tilstand i elver for rapport 2020.xlsx")
...
saveRDS(df_index, "Data/2021/07a_df_index_2020.rds")
saveRDS(df_index_barplot, "Data/2021/07a_df_index_barplot_2020.rds")
saveRDS(df_stations, "Data/2021/07a_df_stations_2020.rds")
